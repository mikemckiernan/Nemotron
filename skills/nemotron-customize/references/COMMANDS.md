...
- Persona MCQ SDG: experiment name, output root, question/answer model endpoint
...
| Persona MCQ SFT | `sdg/persona_mcq` | `uv run nemotron steps run sdg/persona_mcq -c <default-or-tiny> --dry-run pipeline.experiment_name=<name>` |
